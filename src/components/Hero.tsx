      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="border border-white/10 rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-10 lg:p-16 backdrop-blur-[2px]">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              <h1 className="text-clamp-h1 font-bold text-white leading-[1.1] mb-8 tracking-tight">
                <span className="inline-block whitespace-nowrap">중고기계매매 전문 플랫폼</span><br />
                <span className="text-safety-orange">전자동 | 오픈도어</span>
              </h1>
              <p className="text-clamp-p text-white/80 mb-12 max-w-2xl leading-relaxed">
              ...
              <div className="flex flex-wrap gap-6 sm:gap-10 mb-12">
                <div className="flex items-center gap-3 text-white">
                  <div className="w-10 h-10 rounded-full bg-safety-orange/20 flex items-center justify-center border border-safety-orange/30">
              ...
              <button 
                ...
                className="lg:hidden w-full bg-safety-orange text-industrial-blue py-5 rounded-xl font-bold text-xl flex items-center justify-center gap-2 shadow-xl hover:brightness-105 transition-all duration-100 active:scale-95"
              >
                상담 신청하기
            ...
            >
              <div className="bg-white/5 backdrop-blur-md border border-white/10 p-12 rounded-[2.5rem] text-center w-full shadow-2xl relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <a 
                    ...
                    className="w-full bg-safety-orange text-industrial-blue py-5 rounded-xl font-bold text-xl flex items-center justify-center gap-3 shadow-[0_10px_30px_rgba(245,158,11,0.3)] hover:shadow-[0_15px_40px_rgba(245,158,11,0.4)] hover:-translate-y-0.5 transition-all duration-100 group"
                  >
                    상담 신청하기
                    <ArrowRight className="w-6 h-6 group-hover:translate-x-1 transition-transform duration-100" />
                  </a>
                </div>
              </div>
            </motion.div>
