  ...
  const faqSections = [
    {
      ...
      items: [
        {
          question: "Q1. 오픈도어는 어떤 서비스인가요?",
          answer: "오픈도어는 산업용 기계 공급사와 구매자를 연결하는 상담 플랫폼입니다. 공급사는 기계·장비 정보를 등록하고 상담 요청을 받을 수 있는 구조로 운영됩니다."
        },
        {
        ...
        {
          question: "Q9. 왜 오픈도어에 입점해야 하나요?",
          answer: "오픈도어는 산업용 기계 공급사와 구매자를 연결하는 상담 플랫폼입니다. 기계·장비 정보를 기반으로 구매자의 상담 요청이 연결되는 구조로 운영됩니다."
        },
        {
          question: "Q10. 기존 홈페이지나 블로그가 있어도 필요한가요?",
          answer: "기존 홈페이지나 블로그와 함께 운영할 수 있습니다. 오픈도어는 상담 연결 중심의 구조로 운영되기 때문에 추가적인 상담 유입 채널로 활용할 수 있습니다."
        },
        {
      ...
      items: [
        {
          ...
          answer: "아닙니다. 오픈도어는 산업기계 공급사와 구매자를 연결하는 상담 플랫폼입니다."
        },
        {
